 ...
 * @author esfso
 */
public class TelaBuscaPais extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscaPais
     */
    public TelaBuscaPais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public TelaBuscaPais() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(TabelaPais);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaPais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaPais dialog = new TelaBuscaPais(new javax.swing.JFrame(), true);
